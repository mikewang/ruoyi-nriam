...
<script>
import {listAudit3Fourtech} from "@/api/fourtech/fourtech";
...
export default {
  ...
  methods: {
    ...
    getContractList() {
      ...
      listAudit3Fourtech(this.addDateRange(this.queryParams2, this.dateRange)).then(response => {
    ...
    handleAuditFourtech(row) {
      ...
      const path = '/fourtech/audit3/' + row.fourtechid;
