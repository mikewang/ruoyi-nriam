        ...
        >
          <template slot-scope="scope">
            <el-button size="mini"
                       ...
                       v-hasPermi="['fourtech:myaudit:list']"
            >查看
            </el-button>
          </template>
        </el-table-column>
...
<script>
import {listMyAuditFourtech} from "@/api/fourtech/fourtech";

export default {
  name: "sheet_myaudit_index",
  data() {
    return {
      // 遮罩层
      loading: true,
  ...
  methods: {
    ...
    getContractList() {
      ...
      listMyAuditFourtech(this.addDateRange(this.queryParams2, this.dateRange)).then(response => {
