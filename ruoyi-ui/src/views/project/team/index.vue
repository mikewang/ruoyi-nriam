  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px" :key="timer">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="团队负责人" prop="teamleaderidlinktext">
              <el-autocomplete class="input-with-select"
                               v-model="form.teamleaderidlinktext"
          ...
          <el-col :span="12">
            <el-form-item label="创建人员" prop="createuseridlinktext">
              <el-input v-model="form.createuseridlinktext" placeholder="请输入创建人员名称" readonly/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
export default {
  ...
  methods: {
    ...
    handleAdd() {
      ...
      this.form.createuseridlinktext = this.$store.getters.realName;
      this.open = true;
      this.title = "添加团队";
    },
