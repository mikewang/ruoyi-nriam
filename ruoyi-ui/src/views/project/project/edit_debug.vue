          ...
          <el-col :span="8">
            <el-form-item label="项目所属部门" prop="organizationid">
              <el-autocomplete class="input-with-select"
                               ...
                               clearable
                               @select="handleSelectDept" style="display:block;"
              >
              </el-autocomplete>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="项目类型" prop="projecttype">
              ...
              <el-select v-model="form.projectTypeLinkText" placeholder="请选择"  style="display:block;"
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="主持/参与" prop="jointype">
              <el-select v-model="form.jointype" placeholder="请选择"  style="display:block;" @select="selectJointypeValue" clearable @clear="clearJointypeValue" @change="changeJointypeValue">
                <el-option
...
export default {
  ...
  methods: {
    ...
    changeProjectTypeValue(value){
      ...
      if (value) {
        console.log("handleSelectProjectType is " + value);

        const selectedItems = this.projectTypeOptions.filter(function (item) {
          //  console.log("projectTypeOption is " , item["id"]);
          return item["id"] == value;
        })
        const selectedItem = selectedItems[0];

        // console.log("handleSelectProjectType selectedItem is " , selectedItem);

        this.form.projecttype = selectedItem["id"] ;
        this.form.projectTypeLinkText = selectedItem["value"];
      }
      else {
        console.log("handleSelectProjectType is null");
        this.form.projecttype = undefined ;
        this.form.projectTypeLinkText = undefined;
      }
    ...
    queryProjectTypeListSearch(queryString, cb) {
      ...
      var options = this.projectTypeList;
    ...
    selectJointypeValue() {
      ...
      console.log("select jointype = ");
    },


    changeJointypeValue(value) {

      console.log("change jointype" + value );
    },
