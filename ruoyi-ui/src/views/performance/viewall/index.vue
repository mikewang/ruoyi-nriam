...
<script>
import {listViewAll, getVerifyTeamConfirmrequest, getVerifyTeamPointsSum, confirmVerifyTeamRequest, exportVerifyTeam, addVerifyTeamConfirmrequest, updateVerifypoints, getVerifypoints} from "@/api/performance/teamperformance";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listViewAll(this.queryParams).then(response => {
