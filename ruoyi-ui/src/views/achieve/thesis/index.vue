  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button
            ...
            size="mini"
            @click="handleAdd"
            v-hasPermi="['achieve:thesis:list']"
          >新增
          </el-button>
        </el-col>
      ...
      <el-table v-loading="loading" :data="achieveList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="期刊级别" align="center" prop="publishbooklevellinktext" width="100"/>
        <el-table-column label="发表年度" align="center" prop="year" width="60"/>

        <el-table-column label="论文级别" align="center" prop="thesislevel" width="60"/>

        <el-table-column label="作者" align="center" prop="authors" width="100"/>
...
<script>
import {listThesis} from "@/api/achieve/thesis";
import TeamData from "@/views/public/team-data";

export default {
  // 专利
  name: "achieve_thesis_index",
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listThesis(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
    ...
    handleSelectionChange(selection) {
      this.ids = selection.map(item => item.thesisid);
    ...
    handleUpdate(row) {
      ...
      console.log("edit thesis id is ", thesisid);
      this.$router.push({path: '/achieve/thesis/' + thesisid});
    },
