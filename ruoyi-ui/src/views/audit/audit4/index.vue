...
<script>
import {listAudit4Sheet} from "@/api/audit/audit";
import {listAudit4Contract} from "@/api/audit/contract";
...
export default {
  ...
  methods: {
    ...
    handleAuditSheet(row) {
      ...
      const path = '/audit/audit4/' + row.sheetid;
