...
import {listApplyDeleteContract} from "@/api/audit/contract";

export default {
  name: "contract_applydelete_index",
  data() {
    return {
      // 遮罩层
      loading: true,
  ...
  methods: {
    ...
    getContractList() {
      ...
      listApplyDeleteContract(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
