...
<script>
import {listAudit5Sheet} from "@/api/audit/audit";
import {listAudit5Contract} from "@/api/audit/contract";
...
export default {
  ...
  methods: {
    ...
    handleAuditSheet(row) {
      ...
      const path = '/audit/audit5/' + row.sheetid;
