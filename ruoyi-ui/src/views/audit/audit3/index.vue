...
<script>
import {listAudit3Sheet} from "@/api/audit/audit";
import {listAudit3Contract} from "@/api/audit/contract";
...
export default {
  ...
  methods: {
    ...
    handleAuditSheet(row) {
      ...
      const path = '/audit/audit3/' + row.sheetid;
