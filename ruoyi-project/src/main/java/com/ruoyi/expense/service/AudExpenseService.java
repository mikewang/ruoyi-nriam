...
import com.ruoyi.expense.mapper.AudExpenseMapper;
...
@Service
public class AudExpenseService {

    private static final Logger log = LoggerFactory.getLogger(AudExpenseService.class);

    @Resource
    AudExpenseMapper audExpenseMapper;
    ...
    public List<AudExpense> selectExpenseTijiaoren(AudExpense sheet) {

        List<AudExpense> sheetList = audExpenseMapper.selectExpenseTijiaoren(sheet);
