...
public class AudProjectdocController extends BaseController {
    ...
    @GetMapping("/list")
    public AjaxResult list(AudProjectdoc query) {
    ...
    @PostMapping
    public AjaxResult add(@Validated @RequestBody AudProjectdoc project) {
    ...
    @PutMapping
    public AjaxResult edit(@Validated @RequestBody  AudProjectdoc project) {
